...
func (p *Proxy) handleKill(session *driver.Session, query string, node sqlparser.Statement) (*sqltypes.Result, error) {
	log := p.log
	...
	return nil, sqldb.NewSQLError1(1095, "HY000", "You are not owner of thread %d", id)
}
